...
class AdminController {
    ...
    getAddProduct = (req, res, next) => {
        res.render("admin/add-product", { title: "Shop", path: "/admin/add-product" });
    };
    ...
    updateProduct = (req, res, next) => {
        ...
        Product.updateProduct(id,{id: id,title: title, imgUrl: imgUrl, price: +price,description: description});
